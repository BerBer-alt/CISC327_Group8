...
expected_out1 = open(current_folder.joinpath(
    'test_update_profile_boundary_R1.out')).read()
expected_out2 = open(current_folder.joinpath(
    'test_update_profile_boundary_R2.out')).read()
expected_out3 = open(current_folder.joinpath(
    'test_update_profile_boundary_R3.out')).read()
expected_out4 = open(current_folder.joinpath(
    'test_update_profile_boundary_R4.out')).read()
...
def test_update_profile_boundary():
    ...
    assert con.strip() == expected_out1.strip()
    ...
    con = re.sub(r'[\x00-\x1f]', '', output)
    assert con.strip() == expected_out2.strip()
    ...
    con = re.sub(r'[\x00-\x1f]', '', output)
    assert con.strip() == expected_out3.strip()
    ...
    con = re.sub(r'[\x00-\x1f]', '', output)
    assert con.strip() == expected_out4.strip()
